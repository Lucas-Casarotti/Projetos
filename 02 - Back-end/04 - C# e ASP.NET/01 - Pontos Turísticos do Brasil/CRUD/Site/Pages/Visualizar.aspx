<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Visualizar.aspx.cs" Inherits="Site.Pages.Visualizar" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="span10 offset1">
                <div class="row">
                    <h3 class="well">Informações do ponto turístico</h3>
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <a href="Index.aspx" class="btn btn-primary btn-lg">Voltar</a>
                        </div>
                    </div>
                    <br />
